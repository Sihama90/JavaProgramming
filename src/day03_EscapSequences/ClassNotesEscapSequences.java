...
public class ClassNotesEscapSequences {
...
/*
    ...
    println() vs print():
    println(): after printing the last character, appends anew line
    print(): after printing the last character, does not append new line
    Comments:
