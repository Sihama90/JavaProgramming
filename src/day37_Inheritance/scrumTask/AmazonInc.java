...
/*
        ...
        ProductOwner po = new ProductOwner("Suhaib", 29, 'M', "sdet", 3, 1200000, company);

        BusinessAnalyst ba = new BusinessAnalyst("Cihad", 30, 'M', 2, 150000, company);

        ScrumMaster sm = new ScrumMaster("Anel", 26, 'F', "sdet", 4, 1350000, company);
        ...
        for (Tester tester : scrumTeam.testers) {
            System.out.println(tester.companyName +" : "+tester.salary);
        }

        System.out.println("------------------------------------------------");

        for (Developer developer : scrumTeam.developers) {
            System.out.println(developer.companyName +" : "+developer.salary);
        }
