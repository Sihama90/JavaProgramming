...
public class MyClassNotesVariables {
...
/*
    ...
    Topics: Variables  Primitive Data Types  String

        Package name: day04_Variables

    Primitive Data Types:
                            numerical primitives:double > float > long > int > short > byte
    ...
    variable naming rules:
     ...
     How to replace variable names?
                                   ...
                                   4. click Replace All
  Task:
    1. Create a class named Square, write a program that can calculate the area & perimeter of any given square side
                area = side * side;
                perimeter = 4 * side:
    ...
    3. Create a class named Circle, write a program that can calculate the area & perimeter of any given CirclePI,
