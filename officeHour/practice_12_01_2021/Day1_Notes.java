    ...
    Practices:
        ...
        Topic :   Single_If
				...
				========================= Small Tasks ================================
				    ...
				    5-Write an if statement that assigns 20 to the variable a if variable b is 50 AND c is greater
				    than 100

              Task03: Write a function:
		...
		Topic:   If_Else :
								=================== Small Tasks ================================
						1 - Create a program that will accept a number and it will print this statements  according
					        to condition ;
                ...
                Task4: A shop will give discount of 10% if the cost of purchased quantity is more than 1000.
                       Create a quantity variable Suppose, one unit will cost 100.
        ...
        1- Given a character, the task is to check whether the given character is in upper case, lower case, or
        ...
        2-( Scanner Class can be used )
							BMI (Body Mass Index): Program will ask user to enter their mass (kilogram) and their
							height (meters).
                ...
                Topic:   Nested If
                            ...
                            2 - [Qualification For Army]
					            Given information: citizenship(boolean), resident (boolean), and has high school
					            diploma (boolean), and age(int). Determine if the person is qualified to join the
					            army.
        ...
        Topic:   Switch Statements
                    ...
                    2 - Create  a program that accepts weather as String
                        ...
                        INPUT : sunny
                        EXPECTED OUTPUT : The weather is sunny Lets Go to Park
          Task 5: Create  a program that accepts browserName and operatingSystem as String and isBrowserOpen as
                  boolean
                  If the Browser is closed, try to open the corresponding browsers in that operating system to run
                  your code.
...
/*            If the Browser is already opened it should give an error message
        ...
        2.Given a string, return the string made of its first two chars, so the String "Hello" yields "He".
